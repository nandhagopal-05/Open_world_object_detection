...
python train_net.py --dist-url auto --num-gpus 1 --config config/REW/rew_t1_sowod.yaml \
...
python train_net.py --eval-only --inference-rew --resume --dist-url auto --num-gpus 1 \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t1/train.yaml \
...
python train_net.py --resume --eval-only --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t1/self-train.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t1/self-train.yaml \
...
python train_net.py --dist-url auto --num-gpus 1 --config config/REW/rew_t2_sowod.yaml \
	OUTPUT_DIR training_dir/rew/sowod_t2  MODEL.WEIGHTS training_dir/rew/model_final.pth  \

python train_net.py --resume --eval-only --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t2/train.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t2/train.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t2/ft.yaml \
...
python train_net.py --dist-url auto --num-gpus 1 --config config/REW/rew_t3_sowod.yaml \
	OUTPUT_DIR training_dir/rew/sowod_t3  MODEL.WEIGHTS training_dir/rew/model_final.pth  \

python train_net.py --resume --eval-only --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t3/train.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t3/train.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t3/ft.yaml \
...
python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t4/train.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/fs-t4-train \
	MODEL.WEIGHTS training_dir/mepu-sowod/fs-t3-ft/model_final.pth \

python train_net.py --resume --dist-url auto --num-gpus 1 --config config/MEPU-SOWOD/t4/ft.yaml \
