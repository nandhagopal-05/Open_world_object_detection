...
def load_voc_instances_with_extrabboxes(
    ...
    elif extra_bbox_type == "fs_filtered":
        bbox_file = json.load(open(os.path.join(annotation_dirname, "pseudo_label_fs_filtered.json")))
        logger.info("loading pseudo labels from Multimodal Uncertainty-Filtered fs_filtered as unknown")
    elif extra_bbox_type == "st_filtered":
        bbox_file = json.load(open(os.path.join(annotation_dirname, "pseudo_label_st_filtered.json")))
        logger.info("loading pseudo labels from Multimodal Uncertainty-Filtered st_filtered as unknown")
